...
#FEV_slope - takes coefficients and user inputs as inputs, then calculates and returns FEV slope
#FEV_intercept - takes coefficients and user inputs as inputs, then calculates and returns FEV intercept
...
FEV_slope <- function (coefficient_array, trig,
                                   hema,
                                   alb,
                                   glob,
                                   alk_phos,
  ...
  b_fev =
    ...
    ((height^2)*FEV_height_square_effect) +
...
FEV_intercept <- function (coefficient_array,
                                      # follow_up_baseline,
                                      trig,
                                      hema,
                                      alb,
  ...
  b_fev_rc =
    ...
    ((height^2)*FEV_height_square_effect_rc) +
