#added draft version of description that will be in the Help Tab
#currently, it looks best as a word document
#I still need to add the appropriate syntax into my bookdown document in order for the text to look proper in the RStudio document
library(shiny)
library(shinythemes)
library(ggplot2)
library(shinyjs)
...
setwd("~/Documents/RStudio projects1/20171111/FEV_7_7_3")
source('FEV_7_7_3_functions.R')
...
server <- function(input, output, session) {
  ...
  output$markdown <- renderUI({
    HTML(markdown::markdownToHTML(knit('chapter2.Rmd', quiet = TRUE)))
  })
